...
def test_resonance():
    ...
    assert cs(B11.excited_states["5/2^-_1"].excitation_energy) == cs.energy_integrated_cross_section
    ...
    assert np.allclose(
        ...
        np.array([B11.excited_states["5/2^-_1"].excitation_energy - 0.25, B11.excited_states["5/2^-_1"].excitation_energy, B11.excited_states["5/2^-_1"].excitation_energy + 0.25]),
        rtol=1e-5,
    )
    assert np.allclose(
        cs.equidistant_energy_grid((B11.excited_states["5/2^-_1"].excitation_energy - 0.25, B11.excited_states["5/2^-_1"].excitation_energy + 0.25), 3),
        np.array([B11.excited_states["5/2^-_1"].excitation_energy - 0.25, B11.excited_states["5/2^-_1"].excitation_energy, B11.excited_states["5/2^-_1"].excitation_energy + 0.25]),
        rtol=1e-5,
    )
    assert np.allclose(
    ...
    assert np.allclose(
        cs.equidistant_probability_grid((B11.excited_states["5/2^-_1"].excitation_energy - 0.25, B11.excited_states["5/2^-_1"].excitation_energy + 0.25), 3),
        np.array([B11.excited_states["5/2^-_1"].excitation_energy - 0.25, B11.excited_states["5/2^-_1"].excitation_energy, B11.excited_states["5/2^-_1"].excitation_energy + 0.25]),
        rtol=1e-5,
    )
...
def test_warnings():
    ...
    cs = BreitWigner(
        GroundState('0', 0, 1), State('2', 2, 1, 1e-3, {'0': 1.})
    )
