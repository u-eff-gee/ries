...
def test_resonance():
    ...
    assert np.allclose(cs.equidistant_energy_grid(0.5, 3), np.array([4.44498-0.25, 4.44498, 4.44498+0.25]), rtol=1e-5)
    assert np.allclose(cs.equidistant_energy_grid((4.44498-0.25, 4.44498+0.25), 3), np.array([4.44498-0.25, 4.44498, 4.44498+0.25]), rtol=1e-5)
    assert np.allclose(cs.equidistant_probability_grid(0.5, 3), np.array([4.44498-0.25, 4.44498, 4.44498+0.25]), rtol=1e-5)
    assert np.allclose(cs.equidistant_probability_grid((4.44498-0.25, 4.44498+0.25), 3), np.array([4.44498-0.25, 4.44498, 4.44498+0.25]), rtol=1e-5)
