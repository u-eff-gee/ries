...
- `reactions`, list of `CrossSection` objects, all cross sections that contribute to the weighted \
sum.
- `scale_factors`, list of float. The i-th scale factor in the list is used to scale the i-th \
cross section in `self.reactions`.
    """
