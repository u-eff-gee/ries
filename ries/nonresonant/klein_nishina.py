...
class KleinNishina(Nonresonant):
    """(Differential) Cross section for Compton scattering of a photon off a free charged particle
...
- array_like or scalar, solid-angle differential cross section in fm**2.
    ...
    def cs_diff_dEp_dphi(self, E, Ep, phi):
        """Differential cross section w.r.t. the energy of the scattered photon and the azimuthal angle
...
- array_like or scalar, energy-differential cross section in :math:`\\mathrm{fm}^2 \\mathrm{MeV}^{-1}`.
    ...
    def cs_diff_dEp(self, E, Ep):
        """Differential cross section w.r.t. the energy of the scattered photon for an unpolarized incoming photon
...
- array_like or scalar, energy-differential cross section in :math:`\\mathrm{fm}^2 \\mathrm{MeV}^{-1}`.
    ...
    def cs_diff_dtheta(self, E, theta):
        """Differential cross section w.r.t. the polar scattering angle for an unpolarized incoming photon
